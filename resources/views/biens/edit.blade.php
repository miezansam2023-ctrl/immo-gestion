        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="bg-white px-6 py-4 rounded-[2rem] shadow-sm border border-gray-100 flex items-center gap-4">
                <div class="text-right">
                    ...
                    <p class="text-xs font-bold text-gray-600">{{ $bien->updated_at->format('d/m/Y') }} A
                        {{ $bien->updated_at->format('H:i') }}</p>
                </div>
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="bg-white p-8 rounded-[3rem] shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
                            <div class="md:col-span-6">
                                <label class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1">Désignation du
                                    Bien *</label>
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1">Commune
                                    *</label>
                            ...
                            <div class="md:col-span-2">
                                <label
                                    class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1">Quartier</label>
                            ...
                            <div class="md:col-span-3">
                                <label class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1">Type de
                                    Bien</label>
                                <select name="type"
                                    class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl font-bold">
                            ...
                            <div class="md:col-span-3">
                                <label
                                    class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1">RUE/LOT/ILOT</label>
                    ...
                    <div class="bg-white p-8 rounded-[3rem] shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label class="block text-[10px] font-black text-gray-400 uppercase mb-2">Nombre de
                                    pièces</label>
                            ...
                            <div>
                                <label class="block text-[10px] font-black text-gray-400 uppercase mb-2">Superficie
                                    (m²)</label>
                                <input type="number" name="superficie" value="{{ old('superficie', $bien->superficie) }}"
                                    class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl font-bold">
                            </div>
                        </div>
                        ...
                        <div class="mt-8">
                            <label
                                class="block text-[10px] font-black text-gray-400 uppercase mb-4 tracking-widest">Équipements
                                inclus</label>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                ...
                                @foreach (['Piscine', 'Garage', 'Groupe Élec.', 'Ascenseur', 'Climatisation', 'Sécurité 24h/7', 'Wifi', 'Balcon', 'Cuisine Équipée'] as $item)
                                    <label
                                        class="flex items-center p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-emerald-50 transition-all border border-transparent has-[:checked]:border-emerald-200 has-[:checked]:bg-emerald-50/50 group">
                                        <input type="checkbox" name="equipements[]" value="{{ $item }}"
                                            {{ in_array($item, $mesEquips) ? 'checked' : '' }}
                                            class="w-4 h-4 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500">
                                        <span
                                            class="ml-2 text-[9px] font-bold text-gray-400 group-hover:text-emerald-700 uppercase">{{ $item }}</span>
                                    </label>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-8 rounded-[3rem] shadow-sm border border-gray-100">
                        ...
                        <textarea name="description" rows="4"
                            class="w-full bg-gray-50 border-none rounded-3xl p-6 font-medium text-sm text-gray-600 italic focus:ring-2 focus:ring-indigo-500">{{ old('description', $bien->description) }}</textarea>
                    </div>
                </div>
                ...
                <div class="lg:col-span-4 space-y-8">
                    ...
                    <div class="bg-gray-900 p-8 rounded-[3rem] shadow-2xl text-white relative overflow-hidden">
                        ...
                        <div class="relative space-y-6">
                            <div>
                                <label
                                    class="block text-[10px] font-black uppercase text-gray-500 mb-2 tracking-widest">Loyer
                                    Mensuel (HT)</label>
                                <div class="flex items-center bg-white/5 rounded-2xl p-4 border border-white/10">
                                    <input type="number" name="prix_loyer"
                                        value="{{ old('prix_loyer', $bien->prix_loyer) }}"
                                        class="bg-transparent border-none w-full p-0 text-3xl font-black text-indigo-400 focus:ring-0"
                                        required>
                            ...
                            {{-- <div>
                                <label
                                    class="block text-[10px] font-black uppercase text-gray-500 mb-2 tracking-widest">Caution
                                </label>
                                <input type="number" name="prix_caution"
                                    value="{{ old('prix_caution', $bien->prix_caution) }}"
                                    class="w-full bg-white/5 border-none rounded-2xl p-4 font-bold text-sm text-gray-300 focus:ring-2 focus:ring-indigo-500">
                            ...
                            <div>
                                <label
                                    class="block text-[10px] font-black uppercase text-gray-500 mb-2 tracking-widest">Statut
                                    du Bien</label>
                                <select name="statut"
                                    class="w-full bg-indigo-600 border-none rounded-2xl p-4 font-black uppercase text-xs tracking-widest cursor-pointer hover:bg-indigo-500 transition-colors">
                                    <option value="disponible" {{ $bien->statut == 'disponible' ? 'selected' : '' }}>✅
                                        Disponible</option>
                                    <option value="occupe" {{ $bien->statut == 'occupe' ? 'selected' : '' }}>🏠 Occupé
                                    </option>
                                    <option value="maintenance" {{ $bien->statut == 'maintenance' ? 'selected' : '' }}>🛠️
                                        Maintenance</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="bg-indigo-50/50 p-8 rounded-[3rem] border border-indigo-100">
                        <h3 class="text-[10px] font-black text-indigo-600 uppercase tracking-widest mb-4">Propriétaire
                        </h3>
                        <div class="space-y-3">
                            <input type="text" name="nom_proprietaire"
                                value="{{ old('nom_proprietaire', $bien->nom_proprietaire) }}" placeholder="Nom complet"
                                class="w-full px-5 py-3 bg-white border-none rounded-xl font-bold text-xs shadow-sm">
                            <input type="text" name="telephone_proprietaire"
                                value="{{ old('telephone_proprietaire', $bien->telephone_proprietaire) }}"
                    ...
                    {{-- Bloc Photo --}}
                    <div class="bg-white p-8 rounded-[3rem] shadow-sm border border-gray-100" x-data="{
                        ...
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <span class="text-[10px] font-bold text-gray-400"
                                x-text="(existingPhotos.length + newPhotos.length) + '/5 photos'"></span>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                            ...
                            <template x-for="(photo, index) in existingPhotos" :key="'old-' + index">
                                <div class="relative aspect-square group">
                                    ...
                                    <template x-if="index === 0">
                                        <span
                                            class="absolute -top-2 -left-2 bg-emerald-500 text-white text-[8px] font-black px-2 py-1 rounded-lg uppercase shadow-lg">Icône</span>
                                    </template>
                                </div>
                            </template>
                            ...
                            <template x-for="(img, index) in newPhotos" :key="'new-' + index">
                                <div class="relative aspect-square group border-2 border-indigo-200 rounded-2xl p-1">
                                    ...
                                    <template x-if="existingPhotos.length === 0 && index === 0">
                                        <span
                                            class="absolute -top-2 -left-2 bg-emerald-500 text-white text-[8px] font-black px-2 py-1 rounded-lg uppercase shadow-lg">Nouvelle
                                            Icône</span>
                                    </template>
                                </div>
                            </template>
                            ...
                            <template x-if="(existingPhotos.length + newPhotos.length) < maxPhotos">
                                <label
                                    class="relative aspect-square flex flex-col items-center justify-center border-2 border-dashed border-indigo-100 rounded-2xl cursor-pointer hover:bg-indigo-50 transition-all group">
                                    <i
                                        class="fas fa-plus text-indigo-300 group-hover:text-indigo-500 transition-colors"></i>
            ...
            <div class="bg-white rounded-[3rem] shadow-sm border border-gray-100 p-8">
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    ...
                    <div class="flex items-center gap-4 w-full lg:w-auto">
                        {{-- Bouton Annuler --}}
                        <a href="{{ route('biens.index') }}"
                            class="flex-1 lg:flex-none px-8 py-4 bg-gray-100 text-gray-700 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-gray-200 transition-all flex items-center justify-center gap-2">
                        ...
                        {{-- Bouton Aperçu --}}
                        {{-- <button type="button"
                                onclick="alertWithSweetAlert('Fonctionnalité d\'aperçu à venir', 'info')"
                                class="flex-1 lg:flex-none px-8 py-4 bg-blue-500 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-blue-600 transition-all flex items-center justify-center gap-2">
                        ...
                        {{-- Bouton Principal --}}
                        <button type="submit"
                            class="flex-1 lg:flex-none px-8 py-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-2xl font-black text-sm uppercase tracking-widest shadow-xl shadow-emerald-100 hover:shadow-2xl hover:shadow-emerald-200 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 group">
                ...
                {{-- <div class="mt-6 pt-6 border-t border-gray-100">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                        <div class="flex items-center justify-center gap-2 text-sm text-gray-500">
                            ...
                            <span>Dernière sauvegarde: {{ $bien->updated_at->diffForHumans() }}</span>
                        </div>
                        <div class="flex items-center justify-center gap-2 text-sm text-gray-500">
                            <i class="fas fa-user text-emerald-400"></i>
                            <span>Modifié par: {{ auth()->user()->nom }} {{ auth()->user()->prenoms }}</span>
                        </div>
                        <div class="flex items-center justify-center gap-2 text-sm text-gray-500">
